document.getElementById("applyFilters").addEventListener("click", () => {
    ...
    const url = `${URLROOT}/BuyerController/filterBids`;
            ...
            <div class="bid-card">
              ...
              <div class="card-content">
                ...
                <div class="farmer-info">
                  <a href="${URLROOT}/BuyerController/FarmerProfile/${product.user_id}" class="farmer-link">
                    <i class="fa-solid fa-user"></i> Farmer Profile
                  </a>
                  <div class="rating">${stars} (${product.avg_rating || 0})</div>
                </div>
  
                <a href="${URLROOT}/BuyerController/PlaceBid/${product.product_id}" class="action-btn">
