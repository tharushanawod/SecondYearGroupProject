...
<head>
   ...
   <link rel="stylesheet" href="<?php echo URLROOT;?>/css/Moderator/ManageProfile.css" />
   ...
   <div class="container">
      ...
      <div id="uploadModal" class="modal">
         <div class="modal-content">
            ...
            <form class="upload-form" action="<?php echo URLROOT;?>/ModeratorController/uploadProfileImage" method="POST"
      ...
      <div class="content">
         ...
         <form action="<?php echo URLROOT;?>/ModeratorController/ManageProfile" method="post" id="profileForm">
