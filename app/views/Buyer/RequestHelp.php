...
<body>
    ...
    <div class="help-container">
        ...
        <div class="category-boxes">
            <a href="<?php echo URLROOT;?>/BuyerController/showForm/payment" class="category-box payment-category">
                <i class="fas fa-money-bill-wave"></i>
                <h3>Payment Issues</h3>
                <p>Problems with payments, refunds, or billing</p>
            </a>
            
            <a href="<?php echo URLROOT;?>/BuyerController/showForm/system" class="category-box system-category">
                <i class="fas fa-cogs"></i>
                <h3>System Issues</h3>
                <p>Technical issues, bugs, or errors</p>
            </a>
            
            <a href="<?php echo URLROOT;?>/BuyerController/showForm/account" class="category-box account-category">
                <i class="fas fa-user"></i>
                <h3>Account Issues</h3>
                <p>Login problems, profile updates, or account settings</p>
            </a>
            
            <a href="<?php echo URLROOT;?>/BuyerController/showForm/other" class="category-box other-category">
        ...
        <?php if (isset($data['category'])): ?>
            <div class="help-form">
                ...
                <form action="<?php echo URLROOT; ?>/BuyerController/submitRequest" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="form-buttons">
                        ...
                        <button type="button" class="cancel-btn" onclick="window.location.href='<?php echo URLROOT; ?>/BuyerController/requestHelp'">Cancel</button>
                    </div>
                </form>
            </div>
        <?php endif; ?>
