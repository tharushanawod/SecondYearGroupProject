...
<body>
    ...
    <div class="help-container">
        ...
        <div class="category-boxes">
            <a href="<?php echo URLROOT;?>/BuyerController/showForm/payment" class="category-box">
                <i class="fas fa-money-bill-wave"></i>
                <h3>Payment Issues</h3>
                <p>Problems with payments, refunds, or billing</p>
            </a>
            
            <a href="<?php echo URLROOT;?>/BuyerController/showForm/system" class="category-box">
                <i class="fas fa-cogs"></i>
                <h3>System Problems</h3>
                <p>Technical issues, bugs, or errors</p>
            </a>
            
            <a href="<?php echo URLROOT;?>/BuyerController/showForm/account" class="category-box">
                <i class="fas fa-user"></i>
                <h3>Account Issues</h3>
                <p>Login problems, profile updates, or account settings</p>
            </a>
            
            <a href="<?php echo URLROOT;?>/BuyerController/showForm/other" class="category-box">
