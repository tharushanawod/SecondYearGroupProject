...
$amount = number_format((float)$data['order_details']->total_amount, 2, '.', ''); // Only format once
$currency = "LKR"; // Or USD
    ...
    <div class="payment-container">
        ...
        <div class="payment-card">
            ...
            <form action="https://sandbox.payhere.lk/pay/checkout" method="POST">
                ...
                <input type="hidden" name="amount" value="<?php echo $data['order_details']->total_amount; ?>">
