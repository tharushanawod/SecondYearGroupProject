...
<?php require APPROOT . '/views/inc/sidebar.php'; ?>
    ...
    <div class="help-container">
        ...
        <?php if (isset($data['selected_category'])): ?>
            ...
            <a href="<?php echo URLROOT; ?>/AdminController/Help" class="back-link">Back to Categories</a>
                    ...
                    <?php foreach ($data['requests'] as $request): ?>
                        <div class="request">
                            ...
                            <?php if ($request->status !== 'responded' && $request->status !== 'resolved' && $request->status !== 'closed'): ?>
                                <form method="POST" action="<?php echo URLROOT; ?>/AdminController/Help?category=<?php echo urlencode($data['selected_category']); ?>">
            ...
            <div class="category-boxes">
                <?php if (!empty($data['categories'])): ?>
                    <?php foreach ($data['categories'] as $category => $pendingCount): ?>
                        <a href="<?php echo URLROOT; ?>/AdminController/Help?category=<?php echo urlencode($category); ?>" class="category-box">
            ...
            <div class="log-cards">
                ...
                <div class="log-card account-log">
                    ...
                    <div class="log-content">
                        ...
                        <a href="<?php echo URLROOT;?>/AdminController/AccountLog" class="view-all-link">View All Account Logs <i class="fas fa-arrow-right"></i></a>
                    </div>
                </div>
                ...
                <div class="log-card buyer-log">
                    ...
                    <div class="log-content">
                        ...
                        <a href="<?php echo URLROOT;?>/AdminController/BuyerTransactionLog" class="view-all-link">View All Transaction Logs <i class="fas fa-arrow-right"></i></a>
                    </div>
                </div>
                ...
                <div class="log-card farmer-log">
                    ...
                    <div class="log-content">
                        ...
                        <a href="<?php echo URLROOT;?>/AdminController/FarmerTransactionLog" class="view-all-link">View All Transaction Logs <i class="fas fa-arrow-right"></i></a>
                    </div>
                </div>
                ...
                <div class="log-card buyer-log">
                    ...
                    <div class="log-content">
                        ...
                        <a href="<?php echo URLROOT;?>/AdminController/BuyerOrderLog" class="view-all-link">View All Order Logs <i class="fas fa-arrow-right"></i></a>
                    </div>
                </div>
                ...
                <div class="log-card farmer-log">
                    ...
                    <div class="log-content">
                        ...
                        <a href="<?php echo URLROOT;?>/AdminController/FarmerOrderLog" class="view-all-link">View All  Order Logs <i class="fas fa-arrow-right"></i></a>
                    </div>
                </div>
            </div>
        <?php endif; ?>
