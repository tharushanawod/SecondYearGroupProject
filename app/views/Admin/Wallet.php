...
<head>
    ...
    <link rel="stylesheet" href="<?php echo URLROOT; ?>/css/Admin/Wallet.css">
</head>
...
<body>
    ...
    <div class="wallet-container">
        ...
        <div class="wallet-summary">
            ...
            <button class="withdraw-btn" id="withdrawBtn" <?php echo $data['balance'] <= 0 ? 'disabled' : ''; ?>>
            ...
            <table class="transaction-table">
                ...
                <tbody>
                    ...
                    <tr class="transaction-row">
                        <td class="order-id">#<?php echo $transaction->order_id; ?></td>
                        <td><?php echo date('M d, Y', strtotime($transaction->request_date)); ?></td>
                        <td class="amount">Rs. <?php echo number_format($transaction->paid_amount); ?></td>
                        <td>
                            <span class="status">
                                <?php if ($transaction->admin_withdraw_status == 'not_withdrawn'): ?>
                                    <p>Not withdrawn</p>
                                <?php else: ?>
                                    <p>Withdrawn</p>
                                <?php endif; ?>
    ...
    <div class="withdrawal-modal" id="withdrawalModal">
        <div class="modal-content">
            ...
            <!-- FORM: Send using POST to PHP -->
            <form class="withdrawal-form" id="withdrawalForm" method="POST" action="<?php echo URLROOT; ?>/AdminController/processWithdrawal">
