<div class="sidebar">
      ...
      <ul class="nav-list">
        <li class="nav-item">
          ...
          <a href="<?php echo URLROOT;?>/AdminController/Dashboard"><div class="links"><img width="20" height="20" src="https://img.icons8.com/ios/50/dashboard.png" alt="dashboard"/><p>Dashboard</p></div></a>
        </li>
        <li class="nav-item">
        ...
        <li class="nav-item">
          <a href="<?php echo URLROOT;?>/AdminController/AddModerators"><div class="links"><img width="20" height="20" src="https://img.icons8.com/ios/50/commercial-development-management.png" alt="commercial-development-management"/><p>Moderators</p></div></a>
        </li>
        <li class="nav-item">
