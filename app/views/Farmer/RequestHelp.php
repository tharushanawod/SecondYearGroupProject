...
<body>
    ...
    <div class="help-container">
        ...
        <div class="category-boxes">
            <a href="<?php echo URLROOT;?>/FarmerController/showForm/payment" class="category-box payment-category">
                <i class="fas fa-money-bill-wave"></i>
                <h3>Payment Issues</h3>
                <p>Problems with payments, refunds, or billing</p>
            </a>
            
            <a href="<?php echo URLROOT;?>/FarmerController/showForm/system" class="category-box system-category">
                <i class="fas fa-cogs"></i>
                <h3>System Issues</h3>
                <p>Technical issues, bugs, or errors</p>
            </a>
            
            <a href="<?php echo URLROOT;?>/FarmerController/showForm/account" class="category-box account-category">
                <i class="fas fa-user"></i>
                <h3>Account Issues</h3>
                <p>Login problems, profile updates, or account settings</p>
            </a>
            
            <a href="<?php echo URLROOT;?>/FarmerController/showForm/other" class="category-box other-category">
