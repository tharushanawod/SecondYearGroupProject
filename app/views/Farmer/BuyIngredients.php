                ...
                <div class="product-card">
                    ...
                    <div class="product-info">
                        ...
                        <div class="product-actions">
                            <a href="<?php echo URLROOT; ?>/products/view/<?php echo $product->product_id; ?>" class="btn btn-view">
                                View Details
                            ...
                            <a href="<?php echo URLROOT; ?>/FarmerController/ViewCart" class="btn btn-cart">
                                Add To Cart
                                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 576 512">
