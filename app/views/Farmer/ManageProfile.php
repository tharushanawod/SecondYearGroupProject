   ...
   <div class="container">
      ...
      <div id="uploadModal" class="modal">
         <div class="modal-content">
            ...
            <form class="upload-form" action="<?php echo URLROOT;?>/FarmerController/uploadProfileImage" method="POST"
      ...
      <div class="content">
         ...
         <form action="<?php echo URLROOT;?>/FarmerController/ManageProfile" method="post" id="profileForm">
