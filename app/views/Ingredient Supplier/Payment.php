...
<body>
    ...
    <div class="product-page">
        <div class="image-card">
            <img src="<?php echo URLROOT;?>/images/<?php echo $data->image; ?>" alt="<?php echo $data->product_name; ?>">
        </div>
        <div class="product-details">
            <h1><?php echo $data->product_name; ?></h1>
            <p class="price">LKR <?php echo $data->price; ?></p>
            <p class="stock">In Stock</p>
            <p class="description"><?php echo $data->description; ?></p>
            <div class="add-to-cart">
                <input type="number" value="1" min="1">
                <button onclick="addToCart(<?php echo $data->id; ?>)">Add to Cart</button>
            </div>
            <p class="category">Category: <a href="<?php echo URLROOT;?>/SupplierController/<?php echo strtolower($data->category); ?>"><?php echo $data->category; ?></a></p>
        </div>
    </div>
    <div class="tabs">
