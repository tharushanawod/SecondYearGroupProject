...
<body>
    ...
    <div class="help-container">
        ...
        if (isset($data['category'])) {
            ...
            echo '<form action="' . URLROOT . '/ManufacturerController/submitRequest" method="POST" enctype="multipart/form-data">';
            ...
            echo '<button type="button" class="cancel-btn" onclick="window.location.href=\'' . URLROOT . '/ManufacturerController/requestHelp\'">Cancel</button>';
            echo '</div>';
            echo '</form>';
            echo '</div>';
        }
