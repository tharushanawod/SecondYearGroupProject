...
<?php require APPROOT . '/views/inc/sidebar.php'; ?>
  ...
  <h2>Personal Data</h2>
    <div class="profile-group">
      ...
      <img src="<?php echo URLROOT;?>/images/Manufacturer/images.png" alt="Profile Picture" class="profile-picture">
    ...
    <div class="form-group">
      ...
      <input type="text" id="last-name" name="last-name" value="Prima">
    </div>
    <div class="form-group">
    ...
    <div class="form-group">
      ...
      <input type="email" id="email" name="email" value="prima@yahoo.com">
    </div>
