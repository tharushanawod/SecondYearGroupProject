...
<div class="filter-container">
    <div class="filter-bar">
        ...
        <a href="<?php echo URLROOT?>/ManufacturerController/bidProduct"><button class="reset-filters" id="resetFilters">Reset</button></a>
        ...
        <?php foreach ($data as $product): ?>
            <div class="bid-card"  data-quantity="<?php echo $product->quantity; ?>">
                ...
                <div class="card-content">
                    ...
                    <a href="<?php echo URLROOT;?>/ManufacturerController/PlaceBid/<?php echo $product->product_id ;?>" class="action-btn">
...
<script src="<?php echo URLROOT;?>/js/Manufacturer/BidProduct.js"></script>
