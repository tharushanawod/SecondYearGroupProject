  ...
  <section class="About-us">
    ...
    <div class="user-details">
      ...
      <div class="user-icons">
        ...
        <div class="user">
          <img src="./images/buyer.png" alt="farmer" />
          <h2>Buyers</h2>
          <button>456+</button>
        </div>

        <div class="user">
          <img src="./images/worker.png" alt="farmer" />
          <h2>Workers</h2>
          <button>456+</button>
        </div>
      </div>
      ...
      <div class="carousel">
        <div class="card">
          <div class="quote-icon">
            <img src="./images/quotation-mark.png" alt="quote icon" />
          </div>
          ...
          <div class="profile">
            <img class="profile-img" src="./images/card-pic-2.jpg" alt="Juliana Silva" />
        ...
        <div class="card">
          ...
          <div class="profile">
            <img class="profile-img" src="./images/card-pic-1.jpg" alt="Juliana Silva" />
            <div class="profile-info">
              <h4>Nimali P</h4>
              <p>Polonnaruwa</p>
            </div>
        ...
        <div class="card">
          ...
          <div class="profile">
            <img class="profile-img" src="./images/card-pic-3.jpg" alt="Juliana Silva" />
            <div class="profile-info">
              <h4>Sanjeewa T.</h4>
              <p>Kandy</p>
            </div>
        ...
        <div class="card">
          ...
          <div class="profile">
            <img class="profile-img" src="./images/card-pic-4.jpg" alt="Juliana Silva" />
            <div class="profile-info">
              <h4>Lakshmi R.</h4>
              <p>Mathale</p>
            </div>
        ...
        <div class="card">
          ...
          <div class="profile">
            <img class="profile-img" src="./images/card-pic-5.jpg" alt="Juliana Silva" />
            <div class="profile-info">
              <h4>Shayan s.</h4>
              <p>Jaffna</p>
            </div>
